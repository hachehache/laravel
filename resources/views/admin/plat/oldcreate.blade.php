...
@section('content')
    ...
    <form action="{{ route('admin.plat.store') }}" method="get">
        @csrf
        <div>
        ...
        <div class="form--radio-buttons--scrollable">
            ...
            <div>
                <input type="radio" name="photo_plat_id" id="photo_plat_id{{ $photoPlat->id }}" value="{{ $photoPlat->id }}">
