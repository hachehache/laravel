...
class PlatSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // on recupere l'ID de toutes les etiquettes de la collection
        ...
        for ($i = 0; $i < 100; $i++) {
            ...
            // affectation d'une etiquette au plat
            // l'etiquette est choisie au hasard
            // un nombre aléatoire est tiré entre 1 mini à 5 etiquettes maxi
          $count = random_int(1,5);
           // dd($etiquetteIds);
            $shortList= $faker->randomElements($etiquetteIds, 5);
            //dd($shortList);
